...
export const OBSERVABILITY_SUBAGENTS = "Subagents";
export const OBSERVABILITY_SUBAGENTS_EMPTY =
	"No subagent activity in this run.";
export const OBSERVABILITY_SUBAGENTS_COUNT_LABEL = "subagents";
export const OBSERVABILITY_SUBAGENTS_TOTAL_TOKENS = "tokens";
export const OBSERVABILITY_SUBAGENTS_CACHE_HIT = "cache hit";
export const OBSERVABILITY_SUBAGENTS_TOTAL_COST = "cost";
export const OBSERVABILITY_SUBAGENTS_COL_AGENT = "Agent";
export const OBSERVABILITY_SUBAGENTS_COL_TYPE = "Type";
export const OBSERVABILITY_SUBAGENTS_COL_MODEL = "Model";
export const OBSERVABILITY_SUBAGENTS_COL_TURNS = "Turns";
export const OBSERVABILITY_SUBAGENTS_COL_TOOLS = "Tools";
export const OBSERVABILITY_SUBAGENTS_COL_TOKENS = "Tokens";
export const OBSERVABILITY_SUBAGENTS_COL_CACHE = "Cache%";
export const OBSERVABILITY_SUBAGENTS_COL_COST = "Cost";
export const OBSERVABILITY_SUBAGENTS_COL_PCT = "%Run";
export const OBSERVABILITY_SUBAGENTS_COL_DURATION = "Duration";
export const OBSERVABILITY_SUBAGENTS_TYPE_MAIN = "main";
export const OBSERVABILITY_SUBAGENTS_TYPE_SUBAGENT = "subagent";
export const OBSERVABILITY_SUBAGENTS_TOTAL_ROW = "Total";
export const OBSERVABILITY_BREAKDOWN = "Breakdown";
export const OBSERVABILITY_BREAKDOWN_EMPTY =
	"No token or activity data for this trace.";
export const OBSERVABILITY_BREAKDOWN_TURNS = "turns";
export const OBSERVABILITY_BREAKDOWN_TOKENS = "tokens";
export const OBSERVABILITY_BREAKDOWN_CACHE_HIT = "cache hit";
export const OBSERVABILITY_BREAKDOWN_COST = "cost";
export const OBSERVABILITY_BREAKDOWN_TOKENS_TITLE = "Token composition";
export const OBSERVABILITY_BREAKDOWN_COL_KIND = "Token type";
export const OBSERVABILITY_BREAKDOWN_COL_TOKENS = "Tokens";
export const OBSERVABILITY_BREAKDOWN_COL_PCT_TOK = "% Tokens";
export const OBSERVABILITY_BREAKDOWN_COL_COST = "Cost (est)";
export const OBSERVABILITY_BREAKDOWN_COL_PCT_COST = "% Cost";
export const OBSERVABILITY_BREAKDOWN_TIER_FRESH = "Fresh input";
export const OBSERVABILITY_BREAKDOWN_TIER_CACHE_READ = "Cache read";
export const OBSERVABILITY_BREAKDOWN_TIER_CACHE_WRITE = "Cache write";
export const OBSERVABILITY_BREAKDOWN_TIER_OUTPUT = "Output";
export const OBSERVABILITY_BREAKDOWN_TOOLS_TITLE = "Tool use";
export const OBSERVABILITY_BREAKDOWN_COL_TOOL = "Tool";
export const OBSERVABILITY_BREAKDOWN_COL_CALLS = "Calls";
export const OBSERVABILITY_BREAKDOWN_COL_PCT_CALLS = "% Calls";
export const OBSERVABILITY_BREAKDOWN_COL_IO = "I/O";
export const OBSERVABILITY_BREAKDOWN_OUTPUT_TITLE = "Code & content output";
export const OBSERVABILITY_BREAKDOWN_LINES_ADDED = "Lines added";
export const OBSERVABILITY_BREAKDOWN_LINES_REMOVED = "Lines removed";
export const OBSERVABILITY_BREAKDOWN_LINES_NET = "Net lines";
export const OBSERVABILITY_BREAKDOWN_EDITS = "Edits (acc/rej)";
export const OBSERVABILITY_BREAKDOWN_OUTPUT_TOKENS = "Output tokens";
export const OBSERVABILITY_BREAKDOWN_RESPONSE_CHARS = "Response text";
export const OBSERVABILITY_BREAKDOWN_TOOL_IO = "Tool I/O";
export const OBSERVABILITY_BREAKDOWN_COMMITS = "Commits / PRs";
export const OBSERVABILITY_BREAKDOWN_LANGS = "Languages";
export const OBSERVABILITY_BREAKDOWN_TOTAL_ROW = "Total";
export const OBSERVABILITY_BREAKDOWN_COST_NOTE =
	"Per-tier cost is an estimate from public list prices (Anthropic cache read 0.1x, write 1.25x input); the header cost is the captured total.";
